...
public class ManaBarRenderer {
    ...
    public static void render(GuiGraphics graphics, float partialTicks, ManaProvider manaProvider) {
        ...
        renderMainBar(graphics, manaProvider, partialTicks, xPos, yPos,
                borderWidth, borderHeight, barWidth, barHeight,
                barXOffset, barYOffset, animationCycles, frameHeight);

        renderReservedOverlay(graphics, manaProvider, partialTicks,
    ...
    private static void renderMainBar(GuiGraphics graphics, ManaProvider manaProvider,
                                      float partialTicks, int xPos, int yPos,
        ...
        int manaOffset = (int) (((manaProvider.getGameTime() + partialTicks) / 3 % animationCycles)) * frameHeight;
